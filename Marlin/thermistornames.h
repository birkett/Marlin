...
#ifndef THERMISTORNAMES_H_
#define THERMISTORNAMES_H_
...
// Standard thermistors
  ...
  #define THERMISTOR_NAME "EPCOS 100K (alt)"
#elif THERMISTOR_ID == 7
  #define THERMISTOR_NAME "HW 135-104LAG-J01"
#elif THERMISTOR_ID == 71
  #define THERMISTOR_NAME "HW 135-104LAF-J01"
#elif THERMISTOR_ID == 8
  #define THERMISTOR_NAME "NTCS0603E3104FXT"
  ...
  #define THERMISTOR_NAME "NTCS0603E3104FXT (alt)"
#elif THERMISTOR_ID == 13
  #define THERMISTOR_NAME "Hisens 3950"
#elif THERMISTOR_ID == 20
  #define THERMISTOR_NAME "PT100 Ultimainboard"
...
// Modified thermistors
  ...
  #define THERMISTOR_NAME "ATC 204GT-2 1K"
#elif THERMISTOR_ID == 55
  #define THERMISTOR_NAME "ATC 104GT-2 1K"
